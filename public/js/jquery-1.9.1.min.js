...
*/ (function (
  ...
  (b.fn = b.prototype = {
    ...
    b.each('Boolean Number String Function Array Date RegExp Object Error'.split(' '), function (
      e,
      t
    ) {
              ...
              T.getIdNotName
                ...
                : ((i.find.ID = function (e, n) {
                    if (typeof n.getElementById !== A && !d) {
                      ...
                      return r
                        ? r.id === e ||
                          (typeof r.getAttributeNode !== A && r.getAttributeNode('id').value === e)
                          ? [r]
                          : t
                        : [];
                    }
            ...
            CLASS: function (e) {
              ...
              return (
                ...
                ((t = RegExp('(^|' + _ + ')' + e + '(' + _ + '|$)')) &&
                  k(e, function (e) {
                    return t.test(
                      e.className || (typeof e.getAttribute !== A && e.getAttribute('class')) || ''
                    );
                  }))
              );
            },
